...
namespace UI.Li.Common
{
    ...
    public struct Style
    {
        ...
        [Pure]
        public Style Extend(Style parent) => new (
            parentStyle: parent,
            ...
            translate: Translate,
            unityBackgroundImageTintColor: UnityBackgroundImageTintColor,
            unityFont: UnityFont,
            unityFontDefinition: UnityFontDefinition,
            unityFontStyleAndWeight: UnityFontStyleAndWeight,
            unityOverflowClipBox: UnityOverflowClipBox,
            unityParagraphSpacing: UnityParagraphSpacing,
            unitySliceBottom: UnitySliceBottom,
            unitySliceLeft: UnitySliceLeft,
            unitySliceRight: UnitySliceRight,
            unitySliceScale: UnitySliceScale,
            unitySliceTop: UnitySliceTop,
            unityTextAlign: UnityTextAlign,
            unityTextOutlineColor: UnityTextOutlineColor,
            unityTextOutlineWidth: UnityTextOutlineWidth,
            unityTextOverflowPosition: UnityTextOverflowPosition,
